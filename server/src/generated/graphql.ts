...
> = {
  postTwit?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationPostTwitArgs, 'input'>
  >;
  postReply?: Resolver<
    ResolversTypes['Twit'],
    ParentType,
    ContextType,
    RequireFields<MutationPostReplyArgs, 'input'>
  >;
  createUser?: Resolver<
...
> = {
  ...
  replies?: Resolver<
    Array<ResolversTypes['Twit']>,
    ParentType,
    ContextType,
    RequireFields<QueryRepliesArgs, 'id'>
  >;
};

export type TwitResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['Twit'] = ResolversParentTypes['Twit']
> = {
...
export type TwitContentResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['TwitContent'] = ResolversParentTypes['TwitContent']
> = {
  operation?: Resolver<
